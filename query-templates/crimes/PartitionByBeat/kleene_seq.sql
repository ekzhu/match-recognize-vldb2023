select * from crimes match_recognize(
    ...
    pattern (A (B)+ C (D)+ E (F)+)
    define A as (primary_category_id = 24), B as ((primary_category_id = 31) AND (timestamp_long <= (A.timestamp_long + 1800000))), C as ((primary_category_id = 7) AND (timestamp_long <= (A.timestamp_long + 1800000))), D as ((primary_category_id = 2) AND (timestamp_long <= (A.timestamp_long + 1800000))), E as ((primary_category_id = 7) AND (timestamp_long <= (A.timestamp_long + 1800000))), F as ((primary_category_id = 4) AND (timestamp_long <= (A.timestamp_long + 1800000)))
);